...
class CH2OMeasurement(FormaldehydeConcentration, CustomCluster):
    class AttributeDefs(FormaldehydeConcentration.AttributeDefs):
        formaldehyde_offset: Final = ZCLAttributeDef(id=0x210, type=t.int8s, access="rw")
...
(
    QuirkBuilder(EFEKTA, "EFEKTA_Air_Quality_Station_2c")
    ...
    .replaces(CH2OMeasurement, endpoint_id=3)
    .replaces(TempMeasurement, endpoint_id=3)
    .replaces(RHMeasurement, endpoint_id=3)
    .skip_configuration(True)
    .sensor(
        CH2OMeasurement.AttributeDefs.measured_value.name,
    ...
    .number(
        ...
        fallback_name="Adjust formaldehyde",
